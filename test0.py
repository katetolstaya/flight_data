    ...
    for l in lists:
        ...
        for path_dict in paths:
            ...
            if node is not None:
                ...
                # distances = obj.obstacle_distances(planner_path)
                # expert_distances = obj_expert.obstacle_distances(expert_path)

                # print(obj.integrate_path_cost(expert_path) - obj.integrate_path_cost(planner_path))
                #print(obj_expert.integrate_path_cost(expert_path) - obj.integrate_path_cost(planner_path))
